...
public class StartUp {
    ...
    public static void main(String[] args) {
        ...
        Course[] classes = {new IntroToProgrammingCourse("Intro to Primatives and logic", "20-344"),
            new IntroJavaCourse("Objects in Java", "22-125"),
            new AdvancedJavaCourse("Design Patterns with Java", "25-543")
        };
        ...
        for (Course s : classes) {
            if(s instanceof IntroToProgrammingCourse){
            s.enrollInClass(20);
            }
            if(s instanceof IntroJavaCourse){
            s.enrollInClass(18);
            }if(s instanceof AdvancedJavaCourse){
            s.enrollInClass(15);
            }
